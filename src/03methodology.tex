...
For example, mwo5 is the \textbf{m}asked language model using \textbf{W}ordmap tokenization fine-tuned on the \textbf{O}scar dataset of \textbf{5}00000 samples, while msg5 is the the \textbf{m}asked language model using \textbf{s}tandard BERT wordpiece tokenization fine-tuned on the \textbf{G}erParCor dataset of \textbf{5}00000 samples.
All models except for bbgc were trained on the same parameters as seen in table \autoref{tab:modelshyper}.\\
...
\begin{table}[h]
    ...
    \begin{tabular}{lllrrrrl}
        ...
        bbgc & Mixed\footnote{bert-base-german-cased} & BWP & 0.0001 & 810000 & 1024 & 10000 & - \\
        \bottomrule
    \end{tabular}
    \caption{List of all used models and their hyperparameters. LR = learning rate, WU = warmup steps.}
