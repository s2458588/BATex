...
Since both are considerably large
FLOTA was trained on 10000 samples ~\cite[]{FLOTA}, which why for this fine-tuning a sample size of 500000 seems sufficient.
...
The vocabulary generated for this chapter is a list of inflected and non-inflected verbs (as to state the example) provided by two sources: (1) the german verb wiktionary \cite(wiktionary) and (2) a crawl of the GerParCor corpus with the HanTa tagger \cite(hanta).
...
Later, when the verbs where extracted \ac{gerparcor} from gerparcor
